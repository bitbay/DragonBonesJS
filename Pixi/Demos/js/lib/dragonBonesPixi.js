...
(function (dragonBones) {
    ...
    var PixiSlot = (function (_super) {
        ...
        PixiSlot.prototype._updateTransform = function () {
            ...
            this._renderDisplay.setTransform(this.global.x, this.global.y, this.global.scaleX, this.global.scaleY, 0, this.global.skewX, this.global.skewY, this._pivotX, this._pivotY);
        };
        return PixiSlot;
    }(dragonBones.Slot));
